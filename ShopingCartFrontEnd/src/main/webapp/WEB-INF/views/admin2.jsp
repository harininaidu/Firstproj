...
<h4 style= "font-family: Copperplate,Copperplate Gothic Light,fantasy;
      font-size: 15px">Welcome Admin!! </h4> <br><br>
...
<footer class="container-fluid text-center">
  <p style="color: #c19a6b;font-family: Copperplate,Copperplate Gothic Light,fantasy;
      font-size: 15px">DOTING HOMES Copyright:<h3 style = "font-family: Copperplate,Copperplate Gothic Light,fantasy;
      font-size: 15px">Furnish With Your Fingertips</h3></p>  
  <form action="thankyou.jsp" class="form-inline" style="color: #c19a6b">Get deals:
    ...
    <a href="thankyou.jsp" style="color: #000000 "><h3 style="font-family: Copperplate,Copperplate Gothic Light,fantasy;
      font-size: 15px">REGISTER WITH US TODAY!!</h3></a>
