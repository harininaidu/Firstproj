...
<h3 style = "font-family: Copperplate,Copperplate Gothic Light,fantasy;font-size: 35px">Please login with your credentials</h3>  <br>

  
  <form:form action="isValidUser" method="post">
    <table>
      <tr>
        <td><h4 style = "font-family: Copperplate,Copperplate Gothic Light,fantasy;font-size: 35px">User Name:</h4></td>
        <td><input type="text" name="name"></td>
      </tr>

      <tr>
        <td><h4 style = "font-family: Copperplate,Copperplate Gothic Light,fantasy;font-size: 35px">Password:</h4></td>
