...
<div class="collapse navbar-collapse" id="myNavbar">
	...
	<h1  style = "font-family: Copperplate,Copperplate Gothic Light,fantasy; font-size: 25px"> Add a Supplier</h1>
	...
	<br>
	<h3 style = "font-family: Copperplate,Copperplate Gothic Light,fantasy; font-size: 25px">Supplier List</h3>
  ...
  <p style="color: #c19a6b;font-family: Copperplate,Copperplate Gothic Light,fantasy; font-size: 15px">DOTING HOMES Copyright</p>  
